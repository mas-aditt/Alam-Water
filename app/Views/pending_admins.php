...
<head>
    ...
    <title>Admin - Pending Admin</title>
...
<body>
    ...
    <div class="content">
        <h1>Daftar Akun Pending Admin</h1>
            ...
            <table>
                ...
                <?php if (!empty($pendingAdmins)): ?>
                    ...
                    <tr>
                        ...
                        <td><?= $admin['status'] ?></td>
                        <td>
                            <a href="<?= base_url('admin/approveAdmin/' . $admin['id_admin']) ?>">
                            <button class="btn-approve">Setujui</button>
                            </a>
                            <a href="<?= base_url('admin/rejectAdmin/' . $admin['id_admin']) ?>">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="4">Tidak ada data pending admin.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
