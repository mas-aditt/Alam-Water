    ...
    <div class="container">
      <div class="admin-usr">
        ...
        <div class="container-14">
          ...
          <form action="<?= base_url('admin_usr/updateUser/' . $user['id_user']) ?>" method="POST">
          <?= csrf_field() ?>
            <div>
            ...
            <div>
              ...
              <input type="number" id="no_telp" name="no_telp" value="<?= $user['no_telp'] ?>" required>
            </div>
            <div>
            ...
            <a href="<?= base_url('admin_usr') ?>">Cancel</a>
          </form>
        </div>
      </div>
    </div>
